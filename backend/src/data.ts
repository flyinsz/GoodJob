...
export const prospectSuperSearchMissions: ProspectSuperSearchMission[] = [];
export const prospectSuperSearchRounds: ProspectSuperSearchRound[] = [];
export const prospectSuperSearchEvents: ProspectSuperSearchEvent[] = [];
...
export const tradeDocuments: TradeDocument[] = [
  ...
  {
    id: "td_seed_quotation",
    customerId: "c2",
    dealId: "d2",
    revision: 2,
    type: "QUOTATION",
    title: "Sahara Electronics LED 筒灯 报价单",
    number: "QUOTATION-20260701-001",
    issueDate: "2026-07-01",
    buyer: "Sahara Electronics LLC",
    buyerAddress: "Business Bay, Dubai, UAE",
    buyerContact: "Ahmed / procurement@sahara-electronics.ae",
    seller: "GoodJob Trading Co., Ltd.",
    sellerAddress: "Shanghai, China",
    currency: "USD",
    incoterm: "EXW",
    paymentTerm: "T/T 30% deposit, 70% before shipment",
    shippingMethod: "Air freight (optional)",
    portLoading: "Shanghai, China",
    portDischarge: "Dubai, UAE",
    validityDate: "2026-07-31",
    bankInfo: "",
    notes: "Prices are subject to final confirmation. Lead time: 15 working days after deposit. Samples available upon request.",
    language: "EN",
    ...
    items: [
      { id: "tdi_seed_q1", product: "LED Downlight 7W", model: "GJ-DL07", hsCode: "940541", quantity: 500, unit: "PCS", unitPrice: 3.8, originCountry: "China", weightKg: 0.18, packageCount: 25 },
      { id: "tdi_seed_q2", product: "LED Downlight 12W", model: "GJ-DL12", hsCode: "940541", quantity: 300, unit: "PCS", unitPrice: 5.2, originCountry: "China", weightKg: 0.25, packageCount: 15 },
      { id: "tdi_seed_q3", product: "LED Track Light 15W", model: "GJ-TL15", hsCode: "940541", quantity: 200, unit: "PCS", unitPrice: 7.5, originCountry: "China", weightKg: 0.32, packageCount: 10 }
    ]
  },
  {
